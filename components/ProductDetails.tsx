      ...
      <div className="grid items-start gap-12 md:grid-cols-2">
        ...
        <div className="rounded-3xl bg-white p-10 shadow-2xl">
          ...
          <div className="mt-5 flex items-center gap-3">
            ...
            <span className="rounded-full border border-green-500/30 bg-green-500/15 px-4 py-1 text-sm font-semibold text-green-700">
              {product.category}
            </span>
          </div>
          ...
          <div className="mt-10 flex gap-4">
            ...
            <button className="rounded-xl border border-yellow-500 px-8 py-4 font-bold text-yellow-600 transition hover:bg-yellow-500 hover:text-black">
              ⚡ Buy Now
            </button>
          </div>
        </div>
